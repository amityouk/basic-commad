...
ls -la /tmp
echo "#############################Creating file#########################################################################################"
touch /tmp/dir1/file1.text
echo "#############################Writing in file#########################################################################################"
echo "Initial Content" > /tmp/dir1/file1.txt
...
echo "#############################top 5 line ################################################################################""
head -5  /tmp/dir1/file1.txt
echo " #############################botom 5 line ################################################################################"
tail -5 /tmp/dir1/file1.txt
echo " #############################top 10 lines ################################################################################"
head -10  /tmp/dir1/file1.txt

echo "#############################top 5 and bottom 10 lines #####################################################################"
head -5  /tmp/dir1/file1.txt | tail -10 /tmp/dir1/file1.txt
...
##########################################################################
cp -R /tmp/dir1/file2.txt /tmp/dir1/file3.txt
